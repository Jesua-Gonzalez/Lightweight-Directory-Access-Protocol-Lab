# LABTAINER EXERCISE 
# AUTHENTICATE USERS OF LINUX SERVERS USING LDAP SERVICE

This is an open public lab devloped by the [Naval Post Graduate School](https://nps.edu/).\
The tasks/instructions of this project can be found in ldap.pdf

The report of this project can be found in Lightweight Directory Access Protocol (LDAP).pdf, 
which shows all the steps, commands, results and explanations you will use or meet in this lab.

You will learn how LDAP centralizes user accounts and passwords so multiple Linux computers can authenticate from a single directory. You’ll also get hands-on experience configuring Linux systems to use an LDAP server and observing the authentication process.
...
Referrence:
- [How to set up virtual enviornment](https://github.com/CamilYed/Labtainer-ARM-mac?tab=readme-ov-file#preparing-the-labtainer-image-manually)
- [Mac Silicon Labatiner Image](https://nps.edu/web/c3o/labtainer-lab-summary1)
